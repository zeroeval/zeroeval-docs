...
<Steps>
  ...
  <Step title="Organize with sessions, tags, and signals">
    Group related traces into sessions, tag them with metadata for filtering, and attach user feedback as signals.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Python SDK" icon="python" href="/tracing/sdks/python/setup">
    Decorators and context managers for Python apps. Auto-instruments OpenAI, LangChain, Gemini, and more.
  </Card>
  <Card title="TypeScript SDK" icon="js" href="/tracing/sdks/typescript/setup">
    Wrapper functions for Node.js and Bun. Auto-instruments OpenAI and Vercel AI SDK.
  </Card>
