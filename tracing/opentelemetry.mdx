...
<Note>
If you're starting fresh, the [Python SDK](/tracing/sdks/python/setup) or [TypeScript SDK](/tracing/sdks/typescript/setup) provide a simpler setup with automatic LLM instrumentation.
</Note>
