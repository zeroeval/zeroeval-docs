...
Tags are key–value pairs that can be attached to any **span**, **trace**, or **session**.  
They power the facet filters in the ZeroEval console so you can slice-and-dice your telemetry by *user*, *plan*, *model*, *tenant*, or anything else that matters to your business.
...
with ze.span(
    ...
    ze.set_tag(ze.get_current_span(), {"phase": "pre-run"})
